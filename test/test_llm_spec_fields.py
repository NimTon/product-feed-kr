...
@patch("product_feed_kr.listing_llm_enrich.listing_llm_color_vision_enabled", return_value=True)
...
@patch("product_feed_kr.listing_llm_enrich.listing_llm_color_vision_enabled", return_value=False)
