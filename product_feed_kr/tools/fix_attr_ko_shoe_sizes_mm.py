...
from product_feed_kr.wecatalog.wecatalog_size_fix import shoe_sizes_to_kr_mm
...
from product_feed_kr.db.store_sqlite import connect_sqlite, ensure_sqlite_schema, sqlite_db_path, sqlite_update_llm_result
...
def _attr_map_ko_from_row(row: dict[str, Any]) -> dict[str, Any]:
    ...
    if colors_ko:
        from product_feed_kr.db.llm_spec_fields import COLOR_KO
