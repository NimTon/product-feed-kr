...
用法::
    ...
    python -m product_feed_kr.tools.recalc_price_krw_db
    python -m product_feed_kr.tools.recalc_price_krw_db --apply
    python -m product_feed_kr.tools.recalc_price_krw_db --apply --force
"""
...
from product_feed_kr.common.cny_krw_rate import cny_amount_to_krw_won_str, resolve_krw_per_cny
from product_feed_kr.listing.listing_llm_enrich import _cny_price_field_usable, _krw_price_field_usable
from product_feed_kr.common.pf_log import pf_trunc
