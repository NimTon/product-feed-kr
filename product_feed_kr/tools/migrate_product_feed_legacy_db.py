...
用法::
  ...
  python -m product_feed_kr.tools.migrate_product_feed_legacy_db
  python -m product_feed_kr.tools.migrate_product_feed_legacy_db --dry-run
  python -m product_feed_kr.tools.migrate_product_feed_legacy_db --in-place
  python -m product_feed_kr.tools.migrate_product_feed_legacy_db --source data/product_feed\\ 原始.db --output data/product_feed_new.db
"""
...
from product_feed_kr.tools.migrate_llm_spec_db import _LEGACY_COLS, _TARGET_COLS
