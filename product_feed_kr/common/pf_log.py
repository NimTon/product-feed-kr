...
_MOD: dict[str, str] = {
    "product_feed_kr.seven17.seven17_upload": "upload",
    "product_feed_kr.seven17.seven17_category_llm": "category",
    "product_feed_kr.seven17.seven17_llm": "llm",
    "product_feed_kr.listing.listing_llm_enrich": "llm",
    "product_feed_kr.db.store_sqlite": "db",
...
LISTING_LLM_LOGGER_NAME = "product_feed_kr.listing.listing_llm_enrich"
SEVEN17_LLM_LOGGER_NAME = "product_feed_kr.seven17.seven17_llm"
STORE_SQLITE_LOGGER_NAME = "product_feed_kr.db.store_sqlite"

UPLOAD_LOGGER_NAMES: tuple[str, ...] = (
    "product_feed_kr.seven17.seven17_upload",
    "product_feed_kr.seven17.seven17_category_llm",
...
SCRAPE_DB_LOGGER_NAMES: tuple[str, ...] = (
    "product_feed_kr.wecatalog.wecatalog_scrape_store",
    STORE_SQLITE_LOGGER_NAME,
)
...
def configure_scrape_logging(
    ...
    *,
    verbose: bool = False,
    logger_name: str = "product_feed_kr.wecatalog.wecatalog_scrape_store",
) -> None:
