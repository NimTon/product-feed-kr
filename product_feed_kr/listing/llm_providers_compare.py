...
配置填好后执行::
  ...
  python -m product_feed_kr.listing.llm_providers_compare --index 0 --run
  python -m product_feed_kr.listing.llm_providers_compare --goods-id YOUR_GOODS_ID --run -o data/llm_compare/out.json
...
from product_feed_kr.common.pf_log import configure_llm_logging
from product_feed_kr.common.seven17_config import getenv as _cfg_get
from product_feed_kr.common.seven17_config import reload_seven17_config
