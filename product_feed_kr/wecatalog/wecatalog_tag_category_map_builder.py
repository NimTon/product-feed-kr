...
用法（在仓库根目录）::
    ...
    python -m product_feed_kr.wecatalog.wecatalog_tag_category_map_builder --input path/to/custom.txt -v --log-file data/mapbuild.log
...
from product_feed_kr.common.pf_log import configure_module_logging, pf_kv

_log = logging.getLogger(__name__)

_DEFAULT_TXT = REPO_ROOT / "config" / "wecatalog_tag_category_map.txt"
_DEFAULT_JSON = PACKAGE_ROOT / "wecatalog_tag_category_map.json"
...
def write_map_from_txt(
    ...
    *,
    ...
    out_path = target or _DEFAULT_JSON
