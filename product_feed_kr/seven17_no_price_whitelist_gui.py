...
from product_feed_kr.seven17_config import seven17_config_path
from product_feed_kr.wecatalog_tag_category_map_builder import parse_category_map_txt
...
def _map_txt_path() -> Path:
    ...
    return root / "config" / "wecatalog_tag_category_map.txt"
