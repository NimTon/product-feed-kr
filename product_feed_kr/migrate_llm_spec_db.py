...
用法::
  ...
  python -m product_feed_kr.migrate_llm_spec_db
  python -m product_feed_kr.migrate_llm_spec_db --dry-run
  python -m product_feed_kr.migrate_llm_spec_db --no-backup
"""
